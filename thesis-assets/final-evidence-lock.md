...
| 文献证据 | `thesis-assets/literature/references-draft.bib` | 2026-04-26 | 本轮文献增强 | 是 | 否 | 否 | 参考文献工作库；字段不完整文献不强行补造 |
| 答辩材料 | `thesis-assets/defense/defense-slide-map.md` | 2026-04-25 | 当前答辩资料结构 | 正式草稿版 DOCX 不纳入正文，仅作为答辩材料来源 | 是 | 是 | PPT 页级映射表 |
| 答辩材料 | `thesis-assets/defense/defense-script-5-8min.md` | 2026-04-25 | 当前答辩资料结构 | 正式草稿版 DOCX 不纳入正文，仅作为答辩材料来源 | 否 | 是 | 5-8 分钟正式讲稿 |
...
| 当前 Word 工作稿 | `thesis-assets/current/毕业论文正式版（润色回填）.docx` | 2026-05-03 | 已完成 Markdown 润色基准稿真实回填的 Word 工作稿 | 是 | 否 | 否 | 后续进入 Word 目录域更新、页码、页眉页脚、图题表题和参考文献格式终审 |
| Markdown 润色基准稿 | `thesis-assets/current/thesis-polished.md` | 2026-05-03 | Markdown 润色基准稿 | 是 | 否 | 否 | 当前内容定版后的 Markdown 基准稿 |
