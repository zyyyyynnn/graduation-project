...
本表用于锁定论文终稿前资料状态。当前采用“已完成 / 仍需人工补齐 / 预留待测 / 可选补充”口径，避免与证据锁版记录和第五章测试数据互相矛盾。
...
| Demo 性能采集 | SSE TTFB、SSE 总耗时、PDF 上传/解析接口耗时 | `thesis-assets/test-data/demo-business-test-2026-04-25.md` | 已完成；仅代表 Demo Twin 本机回环环境 |
...
| 类别 | 内容 | 目标文件 | 状态 |
| --- | --- | --- | --- |
| 答辩页映射 | PPT 页码、页面主题、证据材料、对应论文章节和讲解要点 | `thesis-assets/defense-slide-map.md` | 已补齐 |
| 正式讲稿 | 5-8 分钟答辩讲稿 | `thesis-assets/defense-script-5-8min.md` | 已补齐 |
| 论文正式草稿版 | 前置页、摘要、自动目录、六章正文、参考文献与附录整合为 DOCX | `thesis-assets/毕业论文正式版（草稿）.docx` | 已补齐；仍需正式模板替换 |
